  ...
  return (
    <div className="flex flex-row-reverse h-screen overflow-hidden text-white/90 selection:bg-indigo-500/40 mobile-stack">
      ...
      <aside className="w-[340px] flex-shrink-0 border-r border-white/5 bg-[#080808]/95 backdrop-blur-xl flex flex-col z-20 tech-corners mobile-sidebar tablet-sidebar">
        <header className="p-5 flex flex-col gap-3 border-b border-white/5 bg-black/20 mobile-header">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/20 font-bold uppercase tracking-[0.2em] mt-1">{t.sidebar.subtitle}</p>
              </div>
            </div>

            <div className="flex items-center gap-1">
              <a
                href={`https://wa.me/5531999982884?text=${encodeURIComponent('Talita, preciso de suporte na Agencia IA Studio')}`}
                target="_blank"
                rel="noopener noreferrer"
                title="Suporte via WhatsApp"
                className="p-2 hover:bg-green-500/10 rounded-lg text-green-400 hover:text-green-300 transition-all"
              >
          ...
          {user && (
            <div className="flex items-center gap-2 px-1">
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-indigo-500 to-pink-500 flex items-center justify-center text-[10px] font-bold uppercase flex-shrink-0">
